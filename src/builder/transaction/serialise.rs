...
use super::model::{Address, Input, MintAssets, OutputAssets, RedeemerPurpose};
use super::{Bytes, Bytes32, Bytes64, Hash28};
...
mod tests {
    ...
    use pallas::ledger::primitives::{Fragment, MaybeIndefArray};

    use super::*;
    use crate::builder::transaction::model::*;
    use crate::builder::transaction::{Bytes64, DatumBytes, DatumHash, Hash28, TransactionStatus};
    ...
    fn staging_json_roundtrip() {
        ...
        let tx = StagingTransaction {
            ...
            language_view: Some(pallas::ledger::primitives::conway::LanguageView(1, vec![1, 2, 3])),
            auxiliary_data: None,
        };
